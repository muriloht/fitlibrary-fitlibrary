...
public class ParseTest extends TestCase {
	public void testParsing() throws Exception {
		Parse p = new Parse("leader<Table foo=2>body</table>trailer",
				new String[] { "table" });
...
//	}
	...
	public void testText() throws Exception {
		...
		assertEquals("a>b & b>c &", p.text());
		p = new Parse(
				"<TD><P><FONT FACE=\"Arial\" SIZE=2>GroupTestFixture</FONT></TD>",
				tags);
	...
	public void testFindNestedEnd() throws FitParseException {
		...
		assertEquals(14,
				Parse.findMatchingEndTag("<t></t><t></t></t>", 0, "t", 0));
	}
	...
	public void testNestedTables2() throws Exception {
		String nestedTable = "<table><tr><td>embedded</td></tr></table>";
		String nestedTable2 = "<table><tr><td>" + nestedTable
				+ "</td></tr><tr><td>two</td></tr></table>";
		Parse p = new Parse("<table><tr><td>one</td></tr><tr><td>"
				+ nestedTable2 + "</td></tr>"
