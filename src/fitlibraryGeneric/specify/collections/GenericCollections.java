...
public class GenericCollections implements DomainFixtured {
	...
	private List<List<Colour>> aListOfLists = ListCreator.list(
			ListCreator.list(Colour.RED, Colour.GREEN),
			ListCreator.list(Colour.YELLOW, Colour.BLUE));
	private Set<Set<Colour>> aSetOfSets = ListCreator.set(
			ListCreator.set(Colour.RED, Colour.GREEN),
			ListCreator.set(Colour.YELLOW, Colour.BLUE));
	private List<Set<Colour>> aListOfSets = ListCreator.list(
			ListCreator.set(Colour.RED, Colour.GREEN),
			ListCreator.set(Colour.YELLOW, Colour.BLUE));
	private Set<List<Colour>> aSetOfLists = ListCreator.set(
			ListCreator.list(Colour.RED, Colour.GREEN),
			ListCreator.list(Colour.YELLOW, Colour.BLUE));
