...
/**
 * Ensures that a DomainAdapter has its setUp() method called once when it's first added
 * and has its tearDown() method called once when it's last removed.
 * This allows or DomainAdapters that are referenced several times, such as through the "calculate" action.
 */
public class SetUpTearDownManager {
	...
	public void addReferences(Object sut, MethodCaller methodCaller) {
		Object object = sut;
	...
	public void removeReferences(Object sut, MethodCaller methodCaller) {
		Object object = sut;
		while (object instanceof DomainAdapter) {
