...
public class StringAdapter implements DomainAdapter {
	...
	@SimpleAction(wiki="|''<i>index of</i>''|text|",
	...
	@SimpleAction(wiki="|''<i>index of</i>''|text|''<i>from</i>''|start|",
	...
	@SimpleAction(wiki="|''<i>last index of</i>''|text|",
	...
	@SimpleAction(wiki="|''<i>compare to</i>''|text|",
	...
	@SimpleAction(wiki="|''<i>is equals</i>''|text|",
	...
	@SimpleAction(wiki="|''<i>contains</i>''|text|",
	...
	@SimpleAction(wiki="|''<i>replace</i>''|pattern|replacement|",
