 ...
 * o To parse cell values into objects, such as for method arguments
 * o To check that a cell value matches the actual object (with colouring)
 * o To take the result of a method (including a getter) to map it onto a value or table, show it, etc
 * 
 * Some Parsers are used without change (such as those used in ArrayTraverse and subclasses), while
