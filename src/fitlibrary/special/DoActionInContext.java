...
//	@Override
//	public boolean equals(Object result, Object expected) throws Exception {
//		Cell cell = TableFactory.cell(expected.toString());
//		return target.getResultParser().matches(cell, result, new TestResultsOnCounts());
//	}
}
